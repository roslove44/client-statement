    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="javascript:; " target="_blank">
                ...
                <span class="ms-1 font-weight-bold">RDS</span>
            </a>
        </div>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/tables.php">
                        ...
                        <span class="nav-link-text ms-1">Etat par Client</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/billing.php">
                        ...
                        <span class="nav-link-text ms-1">Les Règlements</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/profile.php">
                        ...
                        <span class="nav-link-text ms-1">Ajouter Client / Facture</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/rtl.php">
                        ...
                        <span class="nav-link-text ms-1">Ajouter Règlement</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="CS+ SARL" disabled>
                        </div>
                    </div>
